...
<report name="RajModule" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="RAJMODULE" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
      ...
      <group name="G_EMPNO">
        ...
        <dataItem name="EMPNO" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Empno">
          <dataDescriptor expression="employee.EMPNO"
        ...
        <dataItem name="ENAME" datatype="vchar2" columnOrder="12" width="20"
         ...
         defaultLabel="Ename">
          <dataDescriptor expression="employee.ENAME"
        ...
        <dataItem name="JOB" datatype="vchar2" columnOrder="13" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Job">
          <dataDescriptor expression="employee.JOB"
        ...
        <dataItem name="MGR" oracleDatatype="number" columnOrder="14"
         ...
         columnFlags="33" defaultLabel="Mgr">
          <dataDescriptor expression="employee.MGR"
        ...
        <dataItem name="HIREDATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hiredate">
          <dataDescriptor expression="employee.HIREDATE"
        ...
        <dataItem name="SAL" oracleDatatype="number" columnOrder="16"
         ...
         columnFlags="33" defaultLabel="Sal">
          <dataDescriptor expression="employee.SAL"
        ...
        <dataItem name="DEPTNO" oracleDatatype="number" columnOrder="17"
         ...
         columnFlags="33" defaultLabel="Deptno">
          <dataDescriptor expression="employee.DEPTNO"
           descriptiveExpression="DEPTNO" order="7" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountEMPNOPerReport" source="EMPNO" function="count"
    ...
    <summary name="CountSALPerReport" source="SAL" function="count"
     precision="8" reset="report" compute="report" defaultWidth="100000"
     defaultHeight="10000" columnFlags="552" defaultLabel="Count:">
      <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"/>
    </summary>
    ...
    <body>
      <frame name="M_G_EMPNO_GRPFR">
        ...
        <repeatingFrame name="R_G_EMPNO" source="G_EMPNO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_SAL" source="SAL" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="5.43750" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DEPTNO" source="DEPTNO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="6.93750" y="0.18750" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_EMPNO_FTR">
          ...
          <field name="F_CountEMPNOPerReport" source="CountEMPNOPerReport"
          ...
          <field name="F_CountSALPerReport" source="CountSALPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="5.43750" y="0.37500" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </frame>
        <frame name="M_G_EMPNO_HDR">
          ...
          <text name="B_ENAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.50000" y="0.00000" width="1.12500"
             height="0.18750"/>
          ...
          <text name="B_JOB" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.62500" y="0.00000" width="1.12500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_HIREDATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.06250" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_SAL" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.43750" y="0.00000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGEMPNOGRPFR218">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPNO218" asArray="no"/> class="OraColumnHeader"> Empno </th>
   <th <rw:id id="HBENAME218" asArray="no"/> class="OraColumnHeader"> Ename </th>
   <th <rw:id id="HBJOB218" asArray="no"/> class="OraColumnHeader"> Job </th>
   <th <rw:id id="HBMGR218" asArray="no"/> class="OraColumnHeader"> Mgr </th>
   <th <rw:id id="HBHIREDATE218" asArray="no"/> class="OraColumnHeader"> Hiredate </th>
   <th <rw:id id="HBSAL218" asArray="no"/> class="OraColumnHeader"> Sal </th>
   <th <rw:id id="HBDEPTNO218" asArray="no"/> class="OraColumnHeader"> Deptno </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPNO2181" src="G_EMPNO">
   <tr>
    <td <rw:headers id="HFEMPNO218" src="HBEMPNO218"/> class="OraCellNumber"><rw:field id="FEMPNO218" src="EMPNO" nullValue="&nbsp;"> F_EMPNO </rw:field></td>
    <td <rw:headers id="HFENAME218" src="HBENAME218"/> class="OraCellText"><rw:field id="FENAME218" src="ENAME" nullValue="&nbsp;"> F_ENAME </rw:field></td>
    <td <rw:headers id="HFJOB218" src="HBJOB218"/> class="OraCellText"><rw:field id="FJOB218" src="JOB" nullValue="&nbsp;"> F_JOB </rw:field></td>
    <td <rw:headers id="HFMGR218" src="HBMGR218"/> class="OraCellNumber"><rw:field id="FMGR218" src="MGR" nullValue="&nbsp;"> F_MGR </rw:field></td>
    <td <rw:headers id="HFHIREDATE218" src="HBHIREDATE218"/> class="OraCellText"><rw:field id="FHIREDATE218" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
    <td <rw:headers id="HFSAL218" src="HBSAL218"/> class="OraCellNumber"><rw:field id="FSAL218" src="SAL" nullValue="&nbsp;"> F_SAL </rw:field></td>
    <td <rw:headers id="HFDEPTNO218" src="HBDEPTNO218"/> class="OraCellNumber"><rw:field id="FDEPTNO218" src="DEPTNO" nullValue="&nbsp;"> F_DEPTNO </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 <!-- Report Level Summary -->
 <tr>
  <td <rw:headers id="HFCountEMPNOPerReport218" src="HBEMPNO218"/> class="OraTotalNumber">Count: <rw:field id="FCountEMPNOPerReport218" src="CountEMPNOPerReport" nullValue="&nbsp;"> F_CountEMPNOPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFCountSALPerReport218" src="HBSAL218"/> class="OraTotalNumber">Count: <rw:field id="FCountSALPerReport218" src="CountSALPerReport" nullValue="&nbsp;"> F_CountSALPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGEMPNOGRPFR218" -->
