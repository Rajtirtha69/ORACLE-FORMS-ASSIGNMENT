...
<report name="Employee List Report Assignment By Ashish"
 DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="EMPLOYEE LIST REPORT ASSIGNMENT BY ASHISH"
   xmlPrologType="text">
  ...
  <section name="main">
    <body>
      <frame name="M_G_EMPNO_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.00000" height="0.56250"
        />
        ...
        <repeatingFrame name="R_G_EMPNO" source="G_EMPNO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_ENAME" source="ENAME" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.50000" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_JOB" source="JOB" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.00000" y="0.18750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          ...
          <field name="F_DEPTNO" source="DEPTNO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="5.50000" y="0.18750" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_EMPNO_FTR">
          <geometryInfo x="0.00000" y="0.37500" width="6.00000"
           height="0.18750"/>
          ...
          <field name="F_SumSALPerReport" source="SumSALPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            ...
            />
            <geometryInfo x="5.18750" y="0.37500" width="0.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_EMPNO_HDR">
          ...
          <text name="B_ENAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.50000" y="0.00000" width="1.50000"
             height="0.18750"/>
          ...
          <text name="B_DEPTNO" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.50000" y="0.00000" width="0.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGEMPNOGRPFR79">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBEMPNO79" asArray="no"/> class="OraColumnHeader"> Empno </th>
   <th <rw:id id="HBENAME79" asArray="no"/> class="OraColumnHeader"> Ename </th>
   <th <rw:id id="HBJOB79" asArray="no"/> class="OraColumnHeader"> Job </th>
   <th <rw:id id="HBMGR79" asArray="no"/> class="OraColumnHeader"> Mgr </th>
   <th <rw:id id="HBHIREDATE79" asArray="no"/> class="OraColumnHeader"> Hiredate </th>
   <th <rw:id id="HBSAL79" asArray="no"/> class="OraColumnHeader"> Sal </th>
   <th <rw:id id="HBDEPTNO79" asArray="no"/> class="OraColumnHeader"> Deptno </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGEMPNO791" src="G_EMPNO">
   <tr>
    <td <rw:headers id="HFEMPNO79" src="HBEMPNO79"/> class="OraCellNumber"><rw:field id="FEMPNO79" src="EMPNO" nullValue="&nbsp;"> F_EMPNO </rw:field></td>
    <td <rw:headers id="HFENAME79" src="HBENAME79"/> class="OraCellText"><rw:field id="FENAME79" src="ENAME" nullValue="&nbsp;"> F_ENAME </rw:field></td>
    <td <rw:headers id="HFJOB79" src="HBJOB79"/> class="OraCellText"><rw:field id="FJOB79" src="JOB" nullValue="&nbsp;"> F_JOB </rw:field></td>
    <td <rw:headers id="HFMGR79" src="HBMGR79"/> class="OraCellNumber"><rw:field id="FMGR79" src="MGR" nullValue="&nbsp;"> F_MGR </rw:field></td>
    <td <rw:headers id="HFHIREDATE79" src="HBHIREDATE79"/> class="OraCellText"><rw:field id="FHIREDATE79" src="HIREDATE" nullValue="&nbsp;"> F_HIREDATE </rw:field></td>
    <td <rw:headers id="HFSAL79" src="HBSAL79"/> class="OraCellNumber"><rw:field id="FSAL79" src="SAL" nullValue="&nbsp;"> F_SAL </rw:field></td>
    <td <rw:headers id="HFDEPTNO79" src="HBDEPTNO79"/> class="OraCellNumber"><rw:field id="FDEPTNO79" src="DEPTNO" nullValue="&nbsp;"> F_DEPTNO </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumSALPerReport79" src="HBSAL79"/> class="OraTotalNumber">Total: <rw:field id="FSumSALPerReport79" src="SumSALPerReport" nullValue="&nbsp;"> F_SumSALPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGEMPNOGRPFR79" -->
